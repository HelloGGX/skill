...
describe('git utilities', () => {
  ...
  describe('GitCloneError', () => {
    ...
    it('should create timeout error', () => {
      const error = new GitCloneError('Timeout', 'https://github.com/test/repo', true, false)
    ...
    it('should create auth error', () => {
      const error = new GitCloneError('Auth failed', 'https://github.com/test/repo', false, true)
  ...
  describe('cloneRepo', () => {
    it('should throw GitCloneError for invalid repository', async () => {
      ...
      await expect(cloneRepo(invalidUrl)).rejects.toThrow(GitCloneError)
    }, 30000)
